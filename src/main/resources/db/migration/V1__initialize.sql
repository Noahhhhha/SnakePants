...
-- ----------------------------
INSERT INTO `flyway_schema_history` VALUES ('1', '1', 'initialize', 'SQL', 'V1__initialize.sql', '-1378939418', 'root', '2020-12-31 18:02:06', '443', '1');
INSERT INTO `flyway_schema_history` VALUES ('2', '1.1', 'user add field', 'SQL', 'V1.1__user_add_field.sql', '-1736650319', 'root', '2020-12-31 18:02:06', '49', '1');
INSERT INTO `flyway_schema_history` VALUES ('3', '1.2', 'update system config default theme', 'SQL', 'V1.2__update_system_config_default_theme.sql', '687574408', 'root', '2020-12-31 18:02:06', '9', '1');
INSERT INTO `flyway_schema_history` VALUES ('4', '1.3', 'delete system config redis ssl', 'SQL', 'V1.3__delete_system_config_redis_ssl.sql', '-1669204463', 'root', '2020-12-31 18:02:06', '4', '1');
INSERT INTO `flyway_schema_history` VALUES ('5', '1.4', 'alter code', 'SQL', 'V1.4__alter_code.sql', '-327324787', 'root', '2020-12-31 18:02:06', '126', '1');
INSERT INTO `flyway_schema_history` VALUES ('6', '1.5', 'add sensitive word', 'SQL', 'V1.5__add_sensitive_word.sql', '2025643180', 'root', '2020-12-31 18:02:06', '28', '1');
INSERT INTO `flyway_schema_history` VALUES ('7', '1.6', 'add permission about sensitive word', 'SQL', 'V1.6__add_permission_about_sensitive_word.sql', '1809016534', 'root', '2020-12-31 18:02:06', '11', '1');
INSERT INTO `flyway_schema_history` VALUES ('8', '1.7', 'alter oauth user', 'SQL', 'V1.7__alter_oauth_user.sql', '1995083533', 'root', '2020-12-31 18:02:06', '209', '1');
INSERT INTO `flyway_schema_history` VALUES ('9', '1.8', 'add sms region id', 'SQL', 'V1.8__add_sms_region_id.sql', '-1573162888', 'root', '2020-12-31 18:02:06', '3', '1');
INSERT INTO `flyway_schema_history` VALUES ('10', '1.9', 'update system config ws', 'SQL', 'V1.9__update_system_config_ws.sql', '-495143501', 'root', '2020-12-31 18:02:06', '3', '1');
INSERT INTO `flyway_schema_history` VALUES ('11', '1.10', 'delete system config search', 'SQL', 'V1.10__delete_system_config_search.sql', '-1816442396', 'root', '2020-12-31 18:02:06', '3', '1');
INSERT INTO `flyway_schema_history` VALUES ('12', '1.11', 'update system config key', 'SQL', 'V1.11__update_system_config_key.sql', '-1193486508', 'root', '2020-12-31 18:02:06', '5', '1');
INSERT INTO `flyway_schema_history` VALUES ('13', '1.12', 'add indexes', 'SQL', 'V1.12__add_indexes.sql', '-1379568353', 'root', '2020-12-31 18:02:07', '200', '1');
INSERT INTO `flyway_schema_history` VALUES ('14', '1.13', 'add social config', 'SQL', 'V1.13__add_social_config.sql', '1664912674', 'root', '2020-12-31 18:02:07', '4', '1');
...
-- ----------------------------
INSERT INTO `sensitive_word` VALUES ('1', '学习');
...
-- Records of tag
-- ----------------------------
INSERT INTO `tag` VALUES ('8', '大众', null, null, '1', '2021-03-21 17:21:56');
INSERT INTO `tag` VALUES ('10', 'html', null, null, '7', '2021-03-24 19:17:37');
INSERT INTO `tag` VALUES ('11', 'java', null, null, '5', '2021-04-05 15:13:09');
INSERT INTO `tag` VALUES ('12', 'css', null, null, '5', '2021-04-05 15:13:09');
INSERT INTO `tag` VALUES ('13', 'python', null, null, '5', '2021-04-05 15:13:09');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('12', 'Wang', '$2a$10$rdW8m1YRkt39I.Hz6PeIG.dJCtLnFVTTds5lU.y22i2abK0/7m9qC', 'http://localhost:8091/data/upload/avatar/Wang/avatar.png', '895206853@qq.com', null, null, null, '40', '2021-03-21 17:20:12', '959d5284-67b4-45dd-a3c0-4a378efaf956', null, '\0', '', '00000000001', '00000000000');
INSERT INTO `user` VALUES ('13', 'zhiwen', '$2a$10$ANJbBBP40z.C0SCOIqweO.Bj8cdmQhHDVdG7CWByVmL4X6MjgWX5e', 'http://localhost:8091/data/upload/avatar/zhiwen/avatar.png', '492333711@qq.com', null, null, null, '0', '2021-03-22 19:04:30', '58f9a2e3-ee0b-4856-b68a-0e58d08e565c', null, '\0', '\0', '00000000000', '00000000000');
